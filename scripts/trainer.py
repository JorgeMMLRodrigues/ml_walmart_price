...
class ModelTrainer:
    def __init__(
        ...
        """
        General‐purpose model trainer with grid/random search, CV, imbalance
        sampling, custom metrics, threshold tuning, and CSV logging.
        """
        self.X = X
        self.y = y
        ...
        if self.problem_type == "auto":
            ...
            try:
                ...
                self.problem_type = ("clf" if getattr(mdl, "_estimator_type", "")=="classifier"
                                     else "reg")
            except:
